...
const double ROTATION_SPEED = 270.0; // deg/s
const double SPEED = 190.0; // p/s
...
void MoveBullet() {
	...
	for (int i = 0; i < ind; i++) {
		...
		bullets[i]->IncrementY(sin(3.14159265359 / 180.0 * ((bullets[i]->projectileAngle - 90.0))) * deltaTime / 1000000.0 * SPEED * 1.2);
		bullets[i]->IncrementX(cos(3.14159265359 / 180.0 * ((bullets[i]->projectileAngle - 90.0))) * deltaTime / 1000000.0 * SPEED * 1.2);
	}
}
